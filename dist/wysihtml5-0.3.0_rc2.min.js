...
(function(b){var c="<br>"+(b.browser.needsSpaceAfterLineBreak()?" ":"");b.commands.insertLineBreak={exec:function(a,d){null===a.config.breakElement?a.commands.support(d)?(a.doc.execCommand(d,!1,null),b.browser.autoScrollsToCaret()||a.selection.scrollIntoView()):a.commands.exec("insertHTML",c):(a.commands.exec("insertHTML",c),b.commands.formatBlock.exec(a,"formatBlock",a.config.breakElement),a.commands.exec("insertHTML",c))},state:function(){return!1},value:function(){}}})(wysihtml5);
