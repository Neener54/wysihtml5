...
window.rangy=function(){function b(b,a){var c=typeof b[a];return c==k||!!(c==g&&b[a])||"unknown"==c}function c(b,a){return!!(typeof b[a]==g&&b[a])}function a(b,a){return typeof b[a]!=j}function d(b){return function(a,c){for(var d=c.length;d--;)if(!b(a,c[d]))return!1;return!0}}function e(b){return b&&m(b,r)&&x(b,p)}function f(b){window.alert("Rangy not supported in your browser. Reason: "+b);o.initialized=!0;o.supported=!1}function h(){if(!o.initialized){var a,d=!1,g=!1;b(document,"createRange")&&
...
(function(b){b.browser.needsSpaceAfterLineBreak();b.commands.insertLineBreak={exec:function(c){b.commands.formatBlock.exec(c,"formatBlock","P")},state:function(){return!1},value:function(){}}})(wysihtml5);
